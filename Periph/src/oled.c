...
{0x10,0x30,0x1F,0x08,0x08,0x00,0x88,0x4F,0x29,0x09,0x09,0x29,0x4F,0x88,0x08,0x00},/*"?",1*/
/* (16 X 16 , ?? )*/

{0x00,0x80,0x60,0xF8,0x07,0x40,0x20,0x18,0x0F,0x08,0xC8,0x08,0x08,0x28,0x18,0x00},
{0x01,0x00,0x00,0xFF,0x00,0x10,0x0C,0x03,0x40,0x80,0x7F,0x00,0x01,0x06,0x18,0x00},/*"?",2*/
/* (16 X 16 , ?? )*/
...
{0x00,0x70,0x08,0x08,0x08,0x08,0xF0,0x00,0x00,0x30,0x28,0x24,0x22,0x21,0x30,0x00},/*"2",4*/
/* (8 X 16 , ?? )*/

{0x00,0x00,0x80,0x40,0x30,0xF8,0x00,0x00,0x00,0x06,0x05,0x24,0x24,0x3F,0x24,0x24},/*"4",5*/
/* (8 X 16 , ?? )*/

{0x00,0xE0,0x10,0x08,0x08,0x10,0xE0,0x00,0x00,0x0F,0x10,0x20,0x20,0x10,0x0F,0x00},/*"0",6*/
/* (8 X 16 , ?? )*/
...
{0x81,0x41,0x21,0x1D,0x21,0x41,0x81,0xFF,0x89,0x89,0x89,0x89,0x89,0x81,0x81,0x00},/*"?",8*/
/* (16 X 16 , ?? )*/

{0x20,0x20,0x20,0xFF,0x20,0x20,0x04,0x04,0x04,0x84,0xE4,0x1C,0x84,0x04,0x04,0x00},
{0x08,0x18,0x08,0x07,0x04,0x14,0x08,0x04,0x02,0x01,0xFF,0x00,0x00,0x03,0x0C,0x00},/*"?",9*/
/* (16 X 16 , ?? )*/

{0x00,0xF8,0x0C,0x0B,0x08,0x08,0xF8,0x40,0x30,0x8F,0x08,0x08,0x08,0xF8,0x00,0x00},
{0x00,0x7F,0x21,0x21,0x21,0x21,0x7F,0x00,0x00,0x00,0x43,0x80,0x40,0x3F,0x00,0x00},/*"?",10*/
...
void OLED_P6x8Value(unsigned short x, unsigned short y, int data)
{
	...
	else if(data >1000)
	{
		...
		if(val[1]!=0||(val[1]==0&&val[1]!=0)) OLED_P6x8Char(x+12,y,val[1]+48);  else OLED_P6x8Char(x+12,y,' ');
...
void OLED_P8x16Value(unsigned short x, unsigned short y,int data)
{
	...
	else if(data >1000)
	{
		...
		val[4] = data%10;
		if(val[0]!=0) 	
      OLED_P8x16Char(x+8,y,val[0]+48); 
    else 
      OLED_P8x16Char(x+8,y,' ');
	  OLED_P8x16Char(x+16,y,val[1]+48);
		OLED_P8x16Char(x+24,y,val[2]+48);
    OLED_P8x16Char(x+32,y,val[3]+48);
    OLED_P8x16Char(x+40,y,val[4]+48);
	}
	else
	{
		val[0] = (data%1000)/100;
    ...
    OLED_P8x16Char(x+16,y,' ');
		if(val[0]!=0) 
      OLED_P8x16Char(x+24,y,val[0]+48); 
    else 
      OLED_P8x16Char(x+24,y,' ');
		if(val[1]==0&&val[0]==0)
      OLED_P8x16Char(x+32,y,' '); 
    else 
      OLED_P8x16Char(x+32,y,val[1]+48);
